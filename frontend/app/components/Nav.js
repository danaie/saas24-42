  ...
  const handleLogOut = (e) => {
    ...
    return (
        ...
        <ul className="flex justify-around list-none p-0 m-0">
          <li><Link href="/submissions" className="text-white font-bold">Submissions</Link></li>
          <li><Link href="/users/analytics" className="text-white font-bold">Analytics
          ...
          <li><Link href="/buy_credits" className="text-white font-bold">Credits
              <svg className="w-5 inline-block ml-1 mb-1 " data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
