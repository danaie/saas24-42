  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        console.error('Error fetching data from /api/get_pending:', error);
      }
    };

    fetchLockedSubmissions();
    fetchData(); // Fetch data from new API route
  }, []);
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow p-5 bg-gray-100">
        ...
        */}
        ...
        {/* New Section: Fetched Data from /api/get */}
        <h2 className="text-2xl font-semibold text-center mb-5 text-black">Fetched Data</h2>
        <div className="flex flex-col gap-4 max-h-64 overflow-y-auto">
