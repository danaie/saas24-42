...
class finished_sub_pub { //finished_submission sends msg {user_id:"", username:"", problem_name:"",script:"",problem_id:"", result:"",runtime:""}
    constructor() {
        this.channel = null;
    ...
    async publish_msg(msg) {
        try {
            ...
            this.channel.sendToQueue(queue, Buffer.from(JSON.stringify({
                user_id: msg.user_id,
                username: msg.problem_id,
                problem_name: msg.problem_name,
                script: msg.script,
...
module.exports = finished_sub_pub;
